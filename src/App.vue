<template>
  ...
  <section class="section section-pad day day-1" id="day-1">
    <div class="container center">
      <h3 class="date fisrt-day-title">Friday Nov 10</h3>
      <ul class="lineup">
        <li>
          <h2>Natti Natasha</h2>
          <p>Argentina</p>
        ...
        <li>
          <h2>Shirley Setia</h2>
          <p>New Zealand / India</p>
        </li>
        <li>
          <h2>Axwell /\ Ingrosso</h2>
          <p>Sweden</p>
        </li>
        <li>
          <p>…and more TBA</p>
  ...
  <section class="section section-pad day day-2" id="day-2">
    <div class="container center">
      <h3 class="date">Saturday Nov 11</h3>
      <ul class="lineup">
        <li>
          <h2>Kyary Pamyu Pamyu</h2>
          <p>Japan</p>
        </li>
        <li>
          <h2>Stella Mwangi</h2>
  ...
  <section class="section section-pad day day-3 bg-cover" id="day-3">
    <div class="container center">
      <h3 class="date">Sunday Nov 12</h3>
      <ul class="lineup">
        <li>
          <h2>Swet Shop Boys</h2>
          <p>UK / US</p>
        </li>
        <li>
          <h2>Christine and the Queens</h2>
          <p>France</p>
        </li>
        <li>
          <h2>Ryan McGeady</h2>
  ...
  <section class="section flex-column" id="register">
    <div class="register section-pad">
      <div class="container">
        <div class="eyes"></div>
        <div class="form">
          <h2 class="lunch-medium">Register for festival updates</h2>
          <form class="sign-up">
    ...
    <footer class="footer section-pad">
      <div class="container">
        <img src="@/assets/images/logo.svg" />
        <p>
          <a class="js-scroll button" href="#intro"> ↑ Back to top </a>
        </p>
      </div>
    </footer>
  </section>
